...
Object.assign(es, { "txt_password_security_show_all": "Show all", "txt_password_security_hide_all": "Hide all", "txt_password_security_jump": "Go to item", "txt_password_security_exposed_short": "Exposed {count} times", "txt_password_security_weak_short": "Weak password", "txt_password_security_reused_short": "Reused" ,
  ...
  "txt_sso_web_completed": "Inicio de sesión completado. Puedes cerrar esta pestaña y volver a Bitwarden.",
  "txt_sso_page_title": "Iniciar sesión con SSO",
  "txt_sso_page_description": "Introduce el correo de tu cuenta de NodeWarden para continuar con tu proveedor de identidad.",
  "txt_sso_unavailable": "El SSO no está disponible en este servidor.",
  "txt_sso_client_only": "Esta página debe abrirse desde tu aplicación o extensión de Bitwarden (Iniciar sesión con SSO).",
  "txt_sso_error_invalid_email": "Introduce una dirección de correo válida.",
  "txt_sso_account_title": "Inicio de sesión único (SSO)",
  "txt_sso_account_description": "Vincula tu cuenta del proveedor de identidad (Zitadel). Mientras esté vinculada, el inicio de sesión con contraseña y clave de acceso se desactiva para esta cuenta: inicia sesión por SSO y luego desbloquea la bóveda con tu contraseña maestra.",
  "txt_sso_status_linked": "Vinculado",
  "txt_sso_status_not_linked": "No vinculado",
  "txt_sso_link_button": "Vincular SSO",
  "txt_sso_unlink_button": "Desvincular SSO",
  "txt_sso_linked_success": "SSO vinculado. El inicio de sesión con contraseña y clave de acceso queda desactivado para esta cuenta.",
  "txt_sso_unlinked_success": "SSO desvinculado. El inicio de sesión con contraseña y clave de acceso vuelve a estar disponible.",
  "txt_sso_error_not_linked": "Esta identidad no está vinculada a ninguna cuenta. Inicia sesión con tu contraseña maestra y luego vincula el SSO en los ajustes de la cuenta.",
  "txt_sso_error_already_linked": "Esta cuenta ya está vinculada a otra identidad SSO. Desvincúlala primero.",
  "txt_sso_error_subject_taken": "Esta identidad SSO ya está vinculada a otra cuenta.",
  "txt_sso_not_configured": "El SSO no está configurado en este servidor.",
  "txt_invalid_password": "Contraseña no válida",
  ...
  "txt_sso_error_generic": "Error al iniciar sesión con SSO. Inténtalo de nuevo.",
  "txt_generator_provider": "Proveedor",
  "txt_generator_provider_simplelogin": "SimpleLogin / compatible (MailPal)",
  "txt_generator_forwarded_email": "Alias de correo reenviado",
  "txt_generator_forwarded_description": "Crea un alias real a través de tu servidor compatible con SimpleLogin (p. ej., MailPal o SimpleLogin). Cada generación crea un alias nuevo.",
  "txt_generator_server_url": "URL del servidor",
  "txt_generator_api_key": "Clave de API",
  "txt_generator_alias_type": "Tipo de alias",
  "txt_generator_alias_type_word": "Palabra aleatoria",
  "txt_generator_alias_type_uuid": "UUID",
  "txt_generator_alias_type_custom": "Prefijo personalizado",
  "txt_generator_prefix": "Prefijo",
  "txt_generator_forwarded_error_config": "Introduce la URL del servidor y la clave de API de tu proveedor de alias y vuelve a generar.",
  "txt_generator_forwarded_error_network": "No se pudo contactar con el proveedor de alias. Comprueba la URL del servidor y tu conexión.",
  "txt_generator_forwarded_error_auth": "El proveedor de alias rechazó la clave de API.",
  "txt_generator_forwarded_error_quota": "El proveedor de alias no pudo crear el alias (cuota alcanzada o sin dominio disponible).",
  "txt_generator_forwarded_error_generic": "El proveedor de alias devolvió un error. Inténtalo de nuevo.",
});
