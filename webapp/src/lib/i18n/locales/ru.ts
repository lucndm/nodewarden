...
Object.assign(ru, { "txt_password_security_show_all": "Show all", "txt_password_security_hide_all": "Hide all", "txt_password_security_jump": "Go to item", "txt_password_security_exposed_short": "Exposed {count} times", "txt_password_security_weak_short": "Weak password", "txt_password_security_reused_short": "Reused" ,
  ...
  "txt_sso_client_only": "Эту страницу нужно открывать из приложения или расширения Bitwarden (Вход через SSO).",
  "txt_sso_error_invalid_email": "Введите корректный адрес электронной почты.",
  "txt_sso_account_title": "Единый вход (SSO)",
  "txt_sso_account_description": "Привяжите учётную запись поставщика удостоверений (Zitadel). После привязки вход по мастер-паролю и ключу доступа для этой учётной записи отключается: входите через SSO, затем разблокируйте хранилище мастер-паролем.",
  "txt_sso_status_linked": "Привязано",
  "txt_sso_status_not_linked": "Не привязано",
  "txt_sso_link_button": "Привязать SSO",
  "txt_sso_unlink_button": "Отвязать SSO",
  "txt_sso_linked_success": "SSO привязан. Вход по мастер-паролю и ключу доступа для этой учётной записи отключён.",
  "txt_sso_unlinked_success": "SSO отвязан. Вход по мастер-паролю и ключу доступа снова доступен.",
  "txt_sso_error_not_linked": "Этот идентификатор не привязан ни к одной учётной записи. Войдите с мастер-паролем и привяжите SSO в настройках учётной записи.",
  "txt_sso_error_already_linked": "Эта учётная запись уже привязана к другому идентификатору SSO. Сначала отвяжите его.",
  "txt_sso_error_subject_taken": "Этот идентификатор SSO уже привязан к другой учётной записи.",
  "txt_sso_not_configured": "SSO не настроен на этом сервере.",
  "txt_invalid_password": "Неверный пароль",
  ...
  "txt_sso_error_generic": "Не удалось войти через SSO. Попробуйте ещё раз.",
