...
Object.assign(zhCN, {
  ...
  "txt_sso_client_only": "此页面必须从您的 Bitwarden 应用或扩展打开（使用 SSO 登录）。",
  "txt_sso_error_invalid_email": "请输入有效的邮箱地址。",
  "txt_sso_account_title": "单点登录（SSO）",
  "txt_sso_account_description": "绑定您的身份提供商账户（Zitadel）。绑定后，此账户将禁用密码与通行密钥登录：请改用 SSO 登录，再用主密码解锁保险库。",
  "txt_sso_status_linked": "已绑定",
  "txt_sso_status_not_linked": "未绑定",
  "txt_sso_link_button": "绑定 SSO",
  "txt_sso_unlink_button": "解除绑定 SSO",
  "txt_sso_linked_success": "SSO 已绑定。此账户的密码与通行密钥登录已禁用。",
  "txt_sso_unlinked_success": "SSO 已解除绑定。密码与通行密钥登录已恢复。",
  "txt_sso_error_not_linked": "此身份尚未绑定任何账户。请先用主密码登录，再到账户设置中绑定 SSO。",
  "txt_sso_error_already_linked": "此账户已绑定其他 SSO 身份，请先解除绑定。",
  "txt_sso_error_subject_taken": "此 SSO 身份已绑定到其他账户。",
  "txt_sso_not_configured": "此服务器未配置 SSO。",
  "txt_invalid_password": "密码无效",
  "txt_sso_continue": "使用 SSO 继续",
  "txt_sso_error_no_account": "没有账户与此身份匹配。请先用主密码登录，然后绑定 SSO。",
  "txt_sso_error_disabled": "该账户已被禁用。",
  "txt_sso_error_generic": "SSO 登录失败，请重试。",
