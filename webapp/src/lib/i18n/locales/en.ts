...
Object.assign(en, {
  ...
  "txt_sso_client_only": "This page must be opened from your Bitwarden app or extension (Log in with SSO).",
  "txt_sso_error_invalid_email": "Enter a valid email address.",
  "txt_sso_account_title": "Single sign-on",
  "txt_sso_account_description": "Link your identity provider account (Zitadel). While linked, password and passkey sign-in are disabled for this account: sign in via SSO, then unlock the vault with your master password.",
  "txt_sso_status_linked": "Linked",
  "txt_sso_status_not_linked": "Not linked",
  "txt_sso_link_button": "Link SSO",
  "txt_sso_unlink_button": "Unlink SSO",
  "txt_sso_linked_success": "SSO linked. Password and passkey sign-in are now disabled for this account.",
  "txt_sso_unlinked_success": "SSO unlinked. Password and passkey sign-in are available again.",
  "txt_sso_error_not_linked": "This identity is not linked to any account. Sign in with your master password, then link SSO in Account Settings.",
  "txt_sso_error_already_linked": "This account is already linked to a different SSO identity. Unlink it first.",
  "txt_sso_error_subject_taken": "This SSO identity is already linked to another account.",
  "txt_sso_not_configured": "SSO is not configured on this server.",
  "txt_invalid_password": "Invalid password",
  ...
  "txt_sso_error_generic": "SSO sign-in failed. Please try again.",
