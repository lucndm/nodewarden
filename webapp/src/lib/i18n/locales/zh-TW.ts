...
Object.assign(zhTW, {
  ...
  "txt_sso_web_completed": "登入完成。您可以關閉此分頁並返回 Bitwarden。",
  "txt_sso_page_title": "使用 SSO 登入",
  "txt_sso_page_description": "輸入您 NodeWarden 帳戶的電子郵件，以繼續前往身分提供者。",
  "txt_sso_unavailable": "此伺服器未提供 SSO。",
  "txt_sso_client_only": "此頁面必須從您的 Bitwarden 應用程式或擴充功能開啟（使用 SSO 登入）。",
  "txt_sso_error_invalid_email": "請輸入有效的電子郵件地址。",
  "txt_sso_account_title": "單一登入（SSO）",
  "txt_sso_account_description": "連結您的身分提供者帳戶（Zitadel）。連結後，此帳戶將停用密碼與通行金鑰登入：請改用 SSO 登入，再以主密碼解鎖保險庫。",
  "txt_sso_status_linked": "已連結",
  "txt_sso_status_not_linked": "未連結",
  "txt_sso_link_button": "連結 SSO",
  "txt_sso_unlink_button": "解除連結 SSO",
  "txt_sso_linked_success": "SSO 已連結。此帳戶的密碼與通行金鑰登入已停用。",
  "txt_sso_unlinked_success": "SSO 已解除連結。密碼與通行金鑰登入已恢復。",
  "txt_sso_error_not_linked": "此身分尚未連結任何帳戶。請先以主密碼登入，再到帳戶設定連結 SSO。",
  "txt_sso_error_already_linked": "此帳戶已連結其他 SSO 身分，請先解除連結。",
  "txt_sso_error_subject_taken": "此 SSO 身分已連結至其他帳戶。",
  "txt_sso_not_configured": "此伺服器未設定 SSO。",
  "txt_invalid_password": "密碼無效",
  "txt_sso_continue": "使用 SSO 繼續",
  "txt_sso_error_no_account": "沒有帳戶與此身分相符。請先用主密碼登入，再綁定 SSO。",
  "txt_sso_error_disabled": "此帳戶已停用。",
  "txt_sso_error_generic": "SSO 登入失敗，請重試。",
